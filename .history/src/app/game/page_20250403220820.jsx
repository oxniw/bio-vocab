...
export default function VocabGame() {
  ...
  return (
    <div className="flex flex-col items-center p-6 bg-gray-100 min-h-screen " style={{ backgroundImage: "url('bg.png')" }}>
        <div className="absolute inset-0 bg-cover bg-center -z-10" style={{ backgroundImage: "url('bg.png')" }}></div>

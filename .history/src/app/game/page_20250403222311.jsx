...
export default function VocabGame() {
  ...
  return (
    <div className=" items-center justify-center flex bg-black h-screen ">
      <Image
      ...
      priority
      />
      <div className='w-full h-screen  flex flex-col items-center absolute text-white justify-center'>

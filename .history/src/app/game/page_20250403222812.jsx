...
export default function VocabGame() {
  ...
  return (
    <div className=" items-center justify-center flex bg-black h-screen overflow-x-hidden">
      ...
      priority
      />
      <div className='w-full  flex items-center absolute text-white justify-center overflow-hidden'>
        <div className="flex-col flex items-center w-full p-4 bg-blue-300 max-w-xl rounded-2xl ">

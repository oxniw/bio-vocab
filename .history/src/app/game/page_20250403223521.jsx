...
export default function VocabGame() {
  ...
  return (
    <div className=" items-center justify-center flex bg-black h-screen overflow-x-hidden relative">
      ...
      priority
      />
      <div className='w-full h-screen  flex items-center absolute text-white justify-center overflow-hidden opacity-25 bg-white-300'>
      
        <div className="flex-col flex items-center w-full p-4  max-w-xl rounded-2xl shadow-lg bg-gradient-to-r backdrop-opacity-100">

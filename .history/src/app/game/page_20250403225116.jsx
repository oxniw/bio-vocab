...
export default function VocabGame() {
  ...
  return (
    <div className=" items-center justify-center flex bg-black h-screen overflow-x-hidden relative">
      ...
      <div className="flex-col flex items-center w-full p-4  max-w-xl rounded-2xl shadow-lg bg-gradient-to-r bg-opacity-10 backdrop-blur-lg absolute top-0 left-0"></div>
